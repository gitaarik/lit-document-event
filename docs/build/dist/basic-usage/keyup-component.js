...
import '../document-event.js';

let KeyupComponent = _decorate([customElement('keyup-component')], function (_initialize, _LitElement) {
  class KeyupComponent extends _LitElement {
    constructor(...args) {
      super(...args);
