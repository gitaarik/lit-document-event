...
export let LitDocumentEventDocs = _decorate([customElement('lit-document-event-docs')], function (_initialize, _LitElement) {
  class LitDocumentEventDocs extends _LitElement {
    constructor(...args) {
      super(...args);
